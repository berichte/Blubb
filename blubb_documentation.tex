...
it implements the SQLiteOpenHelper, which manages database creation and version management (http://developer.android.com/reference/android/database/sqlite/SQLiteOpenHelper.html)
